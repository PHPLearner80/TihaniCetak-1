                        ...
                        <div class="modal-content" style="width:1000px; margin-left:-240px;">
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table mt-2 w-100" id="example1">
                                    ...
                                    <tbody>
                                        <tr class="text-center">
                                            <td><select name="" placeholder="Select Location" class="form-control"
                                                    id="">
                                                    <option value="">Area 1 > shelf > level 1</option>
                                                    <option value="">Area 2 > shelf > level 2</option>
                                                </select></td>
                                            <td><input type="text" readonly value="UNIT" name="" id=""
                                                    class="form-control"></td>
                                            <td><input type="text" placeholder="User Input" name="" id=""
                                                    class="form-control"></td>
                                            <td><textarea name="" id="" placeholder="User Input" cols="30"
                                                    rows="1"></textarea></td>
                                            <td><button class="btn btn-primary">print </button></td>
                                            <td>
                                                <div class="row">
                                                    <div class="col-md-6"><button class="btn btn-primary">+</button>
                                                    </div>
                                                    <div class="col-md-6"><button class="btn btn-danger">X</button>
                                                    </div>
